...
/**
 * DTO for VNPay refund status check response
 * Represents the response structure from VNPay refund status queries
 */
@Data
public class VNPayRefundStatusResponse {
    ...
    private String vnp_RequestId;      // Original refund request ID
